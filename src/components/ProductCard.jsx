  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col gap-2">
        <Link to={`/product/${product.id}`} className="group-hover:text-black transition-colors">
          <h3 className="text-sm md:text-base font-medium text-neutral-900 line-clamp-1">
            {product.name}
          </h3>
        </Link>

        <div className="flex items-baseline gap-2">
          <span className="text-sm md:text-base font-semibold text-black">${product.price}</span>
